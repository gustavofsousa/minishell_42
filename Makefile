...
#    Updated: 2023/03/08 14:39:10 by parnaldo         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
MAIN		:=	main.c	signal.c	golfer.c	expand_variables.c expand_variables_utils.c \
				ft_strjoin_free.c create_sentence.c	list_sentence.c
